...
import { calculateViewDimensions, ViewDimensions, BaseChartComponent, ColorHelper } from '../../../src/lib/charts';
import { id } from '../../../src/lib/charts/utils';

@Component({
  selector: 'ana-charts-timeline-filter-bar-chart',
  template: `
    <ana-charts-chart
      [view]="[width, height]"
      [showLegend]="false"
  ...
  `,
  styleUrls: ['../../../src/lib/charts/common/base-chart.component.scss'],
