...
import { colorSets } from '../../src/lib/charts/utils/color-sets';
import { formatLabel } from '../../src/lib/charts/common/label.helper';
import { single, multi, bubble, generateData, generateGraph, treemap, timelineFilterBarData } from '../data/data';
...
@Component({
  ...
  templateUrl: './ngx-app.component.html'
})
