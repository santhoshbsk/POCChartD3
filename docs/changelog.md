...
## 3.1.2
- Enhancement: Add `ana-charts-outer` class to `ana-charts` inner element
...
## 3.0.1
- Updated tooltips to latest version from ana-ui

## 3.0.0
- Renamed project to ana-charts
- Prefixed component selectors with ana-charts-
